...
public class World2 {
	...
	public World2(Handler handler, String path) {
		...
		entityManager.addEntity(new Rock(handler, 500, 300));
		entityManager.addEntity(new Tree(handler, 800, 100));
		entityManager.addEntity(new Rock(handler, 450, 300));
